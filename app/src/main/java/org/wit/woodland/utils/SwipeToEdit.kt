package org.wit.woodland.utils
...
abstract class SwipeToEdit(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT)
{
    ...
    private val backgroundColor = Color.parseColor("#FF4CAF50")
    ...
    override fun onChildDraw(
        ...
        val editIconLeft = itemView.right - editIconMargin - intrinsicWidth!! -700
        val editIconRight = itemView.right - editIconMargin -700
